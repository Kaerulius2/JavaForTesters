...
public class GroupCreationTests extends TestBase {
    ...
    public Iterator<Object[]> validGroupsFromXml() throws IOException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(app.prop().getProperty("path.data.groups.xml")))) {
            String xml = "";
    ...
    public Iterator<Object[]> validGroupsFromJson() throws IOException {
        List<Object[]> list = new ArrayList<Object[]>();
        try (BufferedReader reader = new BufferedReader(new FileReader(app.prop().getProperty("path.data.groups.json")))) {
            String json = "";
            String line = reader.readLine();
            while (line != null) {
                json += line;
